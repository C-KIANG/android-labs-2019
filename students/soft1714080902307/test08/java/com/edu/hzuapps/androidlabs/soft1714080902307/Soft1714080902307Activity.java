...
import com.edu.hzuapps.androidlabs.soft1714080902307.Module.GameModuleActivity;
...
public class Soft1714080902307Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Soft1714080902307Activity.this, GameModuleActivity.class);
                startActivity(intent);
            }
        });
